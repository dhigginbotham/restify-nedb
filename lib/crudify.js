(function() {
  ...
  crudify = function(opts, req, fn) {
    ...
    limit = typeof req.query.limit !== "undefined" && (req.query.limit != null) ? req.query.limit : null;
    skip = typeof req.query.skip !== "undefined" && (req.query.skip != null) ? req.query.skip : null;
    sort = typeof req.query.sort !== "undefined" && (req.query.sort != null) ? req.query.sort : null;
